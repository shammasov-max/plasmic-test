...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: -Cj1XSy6NFiFVi/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: HNUAZzMpNJtjPb/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: p0jxmstd76odnB/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___3RCiO)}
          role={"img"}
        />
      }
      navMenuItems={[
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__fhgt8)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__kHqYd)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__ffWy)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__dE5J)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
